    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uid.getText().toString().equals("satya") &&
                        pwd.getText().toString().equals("satya")) {
                    Toast.makeText(getApplicationContext(),
                            "Logged In",Toast.LENGTH_SHORT).show();
                    reDirectToHomePage();
                }else{
                    Toast.makeText(getApplicationContext(), "Your id or password is wrong. Please try again",Toast.LENGTH_SHORT).show();
